...
namespace WEB.Reports.PDF
{
    public abstract class PDFReports
    {
        ...
        protected PDFReports(ApplicationDbContext dbContext, Settings settings)
        {
            ...
            defaultFont = new Font(baseFont, 9, Font.NORMAL, BaseColor.BLACK);
            h1Font = new Font(baseFont, 16, Font.NORMAL, BaseColor.BLACK);
            h2Font = new Font(baseFont, 14, Font.NORMAL, BaseColor.BLACK);
            h3Font = new Font(baseFont, 12, Font.NORMAL, BaseColor.BLACK);
            h4Font = new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK);
            reportTitleFont = new Font(baseFont, 24, Font.NORMAL, BaseColor.BLACK);
            coverTableFont = new Font(baseFont, 10, Font.NORMAL, BaseColor.GRAY);
        }
        ...
        private static class BaseColor
        {
            ...
            public static Color DARK_GRAY = new Color(System.Drawing.Color.Gray);
            ...
            public static Color iTextColor(System.Drawing.Color color)
            {
